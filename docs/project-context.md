...
- **Known bug, not introduced by this work:** the widget's booking-unavailable fallback still shows "BARK! Denver" copy and phone number, carried over from Marisol Vega's own source — flag before this ships anywhere real.
